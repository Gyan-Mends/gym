              ...
              <form action="" method="">
                <div class="sign-in-htm">
                    ...
                    <div class="group">
                        ...
                        <label for="check"><span class="icon"></span>  I Accept The Terms And Conditions</label>
                    </div>
                    <div class="group">
                        <input type="submit" id="register" class="btn btn-primary button" value="Register">
                        <a style="color:white; padding-buttom:5px;" href="login.php">Switch To login</a>
                    </div>
